...
public class TableConstructorBuilder {
    ...
    public TableConstructorBuilder resetAlignments(Map<Cell, Alignment> alignments) {
        config.setAlignments(alignments);
        return this;
    }
    ...
    public TableConstructorBuilder resetColors(Map<Cell, String> colors) {
        config.setColors(colors);
        return this;
    }

    public TableConstructorBuilder addColors (String color, Cell... cells) {
        for (Cell cell : cells) config.getColors().put(cell, color);
        return this;
    }

    public TableConstructorBuilder addColors (String color, List<Cell> cells) {
        for (Cell cell : cells) config.getColors().put(cell, color);
        return this;
    }
